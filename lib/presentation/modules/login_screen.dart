                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                            ...
                            suffixIcon: IconButton(
                              ...
                              icon: LoginCubit.get(context).isHiddenPassword? const Icon(Icons.visibility_off_outlined):const Icon(Icons.visibility_outlined),
                            )),
                        obscureText: LoginCubit.get(context).isHiddenPassword,
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                      ...
                      ElevatedButton(
                        ...
                        child: ConditionalBuilder(
                            condition: LoginCubit.get(context).loginLoading,
